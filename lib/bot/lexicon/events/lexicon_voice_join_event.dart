...
class LexiconVoiceJoinEvent extends LexiconEvent<VoiceStateUpdateEventFixed> {
  ...
  super(l, "voice_join", "Voice Join Event", "When someone enters a voice channel, the event will trigger.") {
    variables.addAll([
      mentionVariable,
